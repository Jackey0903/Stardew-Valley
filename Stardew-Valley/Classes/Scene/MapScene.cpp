...
// 使用 GameManager::getInstance()->setCurrentMap() 替代全局变量
...
bool MapScene::init() {
  ...
  // 创建map2选择戏按钮
  auto _map2 =
      HoverButton::create("../Resources/MapScene/Map2_D.png", // 默认状态图片
                          "../Resources/MapScene/Map2_L.png", // 选中状态图片
                          "../Resources/MapScene/Map2_L.png"  // 按下状态图片
      );
  _map2->setPosition(Vec2(visibleSize.width / 2 + MAP2_BUTTON_OFFSET_X,
                          visibleSize.height + MAP2_BUTTON_OFFSET_Y));
  _map2->addTouchEventListener(
      [this](
          Ref *sender,
          cocos2d::ui::Widget::TouchEventType type) { // C++11特性：Lambda表达式
  ...
  auto _map3 =
      HoverButton::create("../Resources/MapScene/Map3_D.png", // 默认状态图片
                          "../Resources/MapScene/Map3_L.png", // 选中状态图片
                          "../Resources/MapScene/Map3_L.png"  // 按下状态图片
      );
  _map3->setPosition(Vec2(visibleSize.width / 2 + MAP3_BUTTON_OFFSET_X,
                          visibleSize.height + MAP3_BUTTON_OFFSET_Y));
  _map3->addTouchEventListener(
      [this](
          Ref *sender,
          cocos2d::ui::Widget::TouchEventType type) { // C++11特性：Lambda表达式
        if (type == cocos2d::ui::Widget::TouchEventType::BEGAN) {
  ...
  auto _map1 =
      HoverButton::create("../Resources/MapScene/Map1_D.png", // 默认状态图片
                          "../Resources/MapScene/Map1_L.png", // 选中状态图片
                          "../Resources/MapScene/Map1_L.png"  // 按下状态图片
      );
  _map1->setPosition(Vec2(visibleSize.width / 2 + MAP1_BUTTON_OFFSET_X,
                          visibleSize.height + MAP1_BUTTON_OFFSET_Y));
  _map1->addTouchEventListener(
      [this](
          Ref *sender,
          cocos2d::ui::Widget::TouchEventType type) { // C++11特性：Lambda表达式
        if (type == cocos2d::ui::Widget::TouchEventType::BEGAN) {
  ...
  listener->onKeyPressed = [=](EventKeyboard::KeyCode code,
                               Event *event) { // C++11特性：Lambda表达式
