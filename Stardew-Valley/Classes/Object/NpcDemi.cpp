...
NpcDemi* NpcDemi::createWithPosition(const Vec2& position, const std::string& spriteFile)
{
    NpcDemi* npc = new (std::nothrow) NpcDemi();
...
bool NpcDemi::initWithPosition(const Vec2& position, const std::string& spriteFile)
{
...
void NpcDemi::setupTouchListener()
{
